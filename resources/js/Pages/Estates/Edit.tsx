...
export default function Edit({ estate }: PageProps<{ estate: Estate }>) {
    const { data, setData, put, processing, errors } = useForm({
        name: estate.name,
        address: estate.address,
        units_count: estate.units_count.toString(),
        monthly_dues_amount: estate.monthly_dues_amount.toString(),
        chairman_name: estate.chairman_name,
        chairman_phone: estate.chairman_phone,
        chairman_email: estate.chairman_email ?? '',
    });
